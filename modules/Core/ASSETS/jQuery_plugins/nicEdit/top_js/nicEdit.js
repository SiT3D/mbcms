...
var nicEditorConfig = bkClass.extend({
    ...
    iconsPath: 'http://mbcms/modules/Core/ASSETS/jQuery_plugins/nicEdit/top_js/nicEditorIcons.gif',
...
var nicEditor = bkClass.extend({
    ...
    removeInstancembcms: function () {
        this.nicInstances[0].ne.nicPanel.panelContain.parentElement.remove();
        this.nicInstances.splice(0, 1);
    },
