...
//                if (method_exists($object, 'init_files') && self::__is_dinamic($object) && !\Modules::is_second_init())
//                {
//                    $modules = $object->init_files();
//                    self::__ADDM_module($object, $modules);
//                } //DEL!
            }
        }
    }
    ...
    public static function get_module_view_mc($id)
    {
        ...
        {
            return View::factory($ignore_view, (array)$object); // тут тоже нужно отчасти проходить весь путь
        }
